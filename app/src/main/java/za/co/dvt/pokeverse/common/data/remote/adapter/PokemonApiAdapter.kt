package za.co.dvt.pokeverse.common.data.remote.adapter

import za.co.dvt.pokeverse.common.data.remote.api.PokemonApi
import za.co.dvt.pokeverse.common.data.remote.api.model.pokemon.PokemonListResponse
import za.co.dvt.pokeverse.common.data.remote.implementation.PokeApiImpl
...
class PokemonApiAdapter(
    ...
    override suspend fun fetchPokemon(): PokemonListResponse {
